<?php
	...
	$q=mysql_query("SELECT tt_pesawat_kota.pesawat_kota_tujuan,
							tp_kota.kota_nama
					FROM tt_pesawat_kota
						...
						INNER JOIN tp_kota ON tp_kota.kota_id = tt_pesawat_kota.pesawat_kota_tujuan
					WHERE tt_pesawat_kota.pesawat_kota_asal = '$_GET[asal]'
					ORDER BY tt_pesawat_kota.pesawat_kota_tujuan");
	echo "<option>Pilih Kota Tujuan</option>";
	while($r=mysql_fetch_array($q))
	{
		echo "<option value='$r[pesawat_kota_tujuan]'>$r[kota_nama]</option>";
	}
?>